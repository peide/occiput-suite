...
def demo_PET_reconstruction():
    ...
    figure(figsize=[15, 5]);
    subplot(1, 4, 1);
    imshow(prompts.to_nd_array()[0, 0, :, :], cmap='gray');
    subplot(1, 4, 2);
    imshow(prompts.to_nd_array()[10, 0, :, :], cmap='gray')
    subplot(1, 4, 3);
    imshow(prompts.to_nd_array()[20, 0, :, :], cmap='gray')
    subplot(1, 4, 4);
    imshow(prompts.to_nd_array()[30, 0, :, :], cmap='gray')
